...
// and will return a new String array with the string variable added to the array
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(browserTypes)); // [Chrome, Firefox, Safari, Edge]
        ...
        System.out.println(Arrays.toString(browserTypes)); // [Chrome, Firefox, Safari, Edge, Opera]
    }


    public static String[] addElement (String[]arr, String element){
        String [] newArray = new String[arr.length+1]; // I am creating a totally a new a new array
        int i = 0;
        for( ; i< arr.length; i++){
            newArray[i] = arr[i];
        }
