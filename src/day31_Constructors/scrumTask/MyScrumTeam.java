...
public class MyScrumTeam {
    ...
    public static void main(String[] args) {
        ...
        scrum.addTester(tester1); // sadece tester1 i eklemis oluyor
        scrum.addDeveloper( developer1);

        scrum.addTesters(testers); // Tester[] testers = {tester2, tester3, tester4}; i dahil ediyor
        ...
        System.out.println(scrum);
        //ScrumTeam{PO='Nigara', BA='Huseyin', SM='Neira', total number of testers=3, total number of developers=3, daysOfSprint=14}
