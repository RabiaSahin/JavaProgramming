...
public class ScrumTeam {
    ...
    public String toString() {
        return "ScrumTeam{" +
                ...
                ", BA='" + BA + '\'' +
                ", SM='" + SM + '\'' +
                ", total number of testers=" + testersList.size() + //", testersList= " + testersList idi biz degistirdik
                ", total number of developers=" + devopsList.size() + //", devopsList= " + devopsList idi biz degistirdik
