...
public class SetInterfacePractice {
    ...
    public static void main(String[] args) {
        ...
        //if you wanna be able to remove the object and if order does not matter, HashSet is fastest.
        ...
        //  System.out.println( hashSet.get(4) ); // you can not get specific element because not index number
